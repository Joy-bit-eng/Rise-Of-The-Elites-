...
export const pokemonDatabase: Record<string, EliteData> = {
  ...
  rattata: {
    ...
    isWild: true,
    position: [Math.random() * 30 - 15, 0, Math.random() * 30 - 15],
    evolutionData: { evolvesTo: 'raticate', evolutionLevel: 20 }
  },
  raticate: {
    id: 'raticate',
    name: 'Raticate',
  ...
  spearow: {
    ...
    isWild: true,
    position: [Math.random() * 30 - 15, 0, Math.random() * 30 - 15],
    evolutionData: { evolvesTo: 'fearow', evolutionLevel: 20 }
  },
  fearow: {
    id: 'fearow',
    name: 'Fearow',
  ...
  ekans: {
    ...
    isWild: true,
    position: [Math.random() * 30 - 15, 0, Math.random() * 30 - 15],
    evolutionData: { evolvesTo: 'arbok', evolutionLevel: 22 }
  },
  arbok: {
    id: 'arbok',
    name: 'Arbok',
  ...
  sandshrew: {
    ...
    isWild: true,
    position: [Math.random() * 30 - 15, 0, Math.random() * 30 - 15],
    evolutionData: { evolvesTo: 'sandslash', evolutionLevel: 22 }
  },
  sandslash: {
    id: 'sandslash',
    name: 'Sandslash',
  ...
  steelix: {
    ...
    abilities: ['Rock Head'],
    description: 'Its body has been compressed deep under the ground. As a result, it is even harder than a diamond.',
    rarity: 'epic',
    color: '#B7B7CE',
    isWild: false,
    position: [0, 0, 0]
  ...
  lickitung: {
    ...
    isWild: true,
    position: [Math.random() * 30 - 15, 0, Math.random() * 30 - 15],
    evolutionData: { evolvesTo: 'lickilicky', evolutionCondition: 'Level up knowing Rollout' }
  },
  koffing: {
    id: 'koffing',
    name: 'Koffing',
  ...
  rhydon: {
    ...
    isWild: false,
    position: [0, 0, 0],
    evolutionData: { evolvesTo: 'rhyperior', evolutionCondition: 'Trade with Protector' }
  },
  chansey: {
    id: 'chansey',
    name: 'Chansey',
    ...
    evolutionData: { evolvesTo: 'blissey', evolutionCondition: 'High Friendship' }
  },
  tangela: {
    id: 'tangela',
    name: 'Tangela',
    ...
    isWild: true,
    position: [Math.random() * 30 - 15, 0, Math.random() * 30 - 15],
    evolutionData: { evolvesTo: 'tangrowth', evolutionCondition: 'Level up knowing Ancient Power' }
  },
  kangaskhan: {
    id: 'kangaskhan',
    name: 'Kangaskhan',
  ...
  seadra: {
    ...
    isWild: false,
    position: [0, 0, 0],
    evolutionData: { evolvesTo: 'kingdra', evolutionCondition: 'Trade with Dragon Scale' }
  },
  goldeen: {
    id: 'goldeen',
    name: 'Goldeen',
  ...
  scyther: {
    ...
    isWild: true,
    position: [Math.random() * 20 - 10, 0, Math.random() * 20 - 10],
    evolutionData: { evolvesTo: 'scizor', evolutionCondition: 'Trade with Metal Coat' }
  },
  jynx: {
    id: 'jynx',
    name: 'Jynx',
  ...
  electabuzz: {
    ...
    isWild: true,
    position: [Math.random() * 20 - 10, 0, Math.random() * 20 - 10],
    evolutionData: { evolvesTo: 'electivire', evolutionCondition: 'Trade with Electirizer' }
  },
  magmar: {
    id: 'magmar',
    name: 'Magmar',
    ...
    isWild: true,
    position: [Math.random() * 20 - 10, 0, Math.random() * 20 - 10],
    evolutionData: { evolvesTo: 'magmortar', evolutionCondition: 'Trade with Magmarizer' }
  },
  pinsir: {
    id: 'pinsir',
    name: 'Pinsir',
  ...
  porygon: {
    ...
    isWild: false,
    position: [0, 0, 0],
    evolutionData: { evolvesTo: 'porygon2', evolutionCondition: 'Trade with Up-Grade' }
  },
  omanyte: {
    id: 'omanyte',
    name: 'Omanyte',
...
export const getAllPokemon = () => Object.values(pokemonDatabase);
export const getPokemonById = (id: string) => pokemonDatabase[id];
export const getPokemonByType = (type: string) => 
  Object.values(pokemonDatabase).filter(p => p.type === type || p.secondaryType === type);
export const getPokemonByRarity = (rarity: string) => 
  Object.values(pokemonDatabase).filter(p => p.rarity === rarity);
export const getWildPokemon = () => 
  Object.values(pokemonDatabase).filter(p => p.isWild);
export const getLegendaryPokemon = () => 
  Object.values(pokemonDatabase).filter(p => p.rarity === 'legendary');
export const getStarterPokemon = () => 
  ['bulbasaur', 'charmander', 'squirtle'].map(id => pokemonDatabase[id]);

console.log(`Loaded ${Object.keys(pokemonDatabase).length} Pokemon into database`);